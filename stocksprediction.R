...
sidebar <- dashboardSidebar(
  ...
  sidebarMenu(
    ...
    menuItem("Widgets", icon = icon("th"), badgeLabel = "new",
             badgeColor = "blue"
    ...
    tabItem("dashboard",
            ...
            fluidRow(
              ...
              box(
                ...
                radioButtons("seasonal", "Select", c("Moving Average 10" = "NonSeasonal", ARIMA = "Seasonal")),
...
#Auto.Arima - plot here  Tile#4 
  output$auto.arima <- renderPlot({
   ...
   # plot(AAPL$AAPL.Close)  
    ...
    #arima
    fit <- SMA(Stock_df$Close,ic="bic",n=10)
